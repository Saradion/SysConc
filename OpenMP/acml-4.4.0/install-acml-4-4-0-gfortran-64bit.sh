#!/bin/sh
#
# Installation script for ACML version 4.4.0
...
echo -e "                   =================  "
echo -e ""
echo -e "This script will install ACML version 4.4.0"
...
echo -e "the default location (/opt/acml4.4.0), or enter an alternative path."
...
tarfile=${fromdir}/contents-acml-4-4-0-gfortran-64bit.tgz
...
do
  ...
  if [ -f "${fpgnumakefile}" ]; then
    ...
    sed -e "s%ACMLDIR \(:*\)= /opt/acml4.4.0/%ACMLDIR \1= ${fullpathinstalldir}/%" < \
